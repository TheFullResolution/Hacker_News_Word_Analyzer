...
const Page1Content = () => (
    <div className={style.content}>
        <p>Welcome on Hacker News Word Analyzer, a magnificent project which will provide you with a hyper accurate analysis of Top 10 most occurring words you can find among Hacker News titles and stories.
        </p>
        <p>To see the ranking, go to the&nbsp;
